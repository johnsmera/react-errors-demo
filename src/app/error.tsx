    ...
    <div className="min-h-screen flex flex-col items-center justify-center px-4 bg-[var(--background)]">
      <div className="max-w-md w-full rounded-2xl border border-[var(--border)] bg-[var(--muted-bg)]/50 p-8 shadow-sm">
        <div className="flex items-center gap-3 mb-4">
          <span
            className="flex h-10 w-10 items-center justify-center rounded-full bg-[var(--destructive-bg)] text-[var(--destructive)]"
            aria-hidden
          >
            <svg
              className="h-5 w-5"
        ...
        <p className="text-sm text-[var(--muted)] mb-6">
          Ocorreu um erro neste segmento. Você pode tentar novamente ou navegar
          para outra página.
        </p>
        <button
          type="button"
